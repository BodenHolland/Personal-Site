...
const booksData = [
  {
    ...
    highlights: [
      ...
      { text: "March 15, 1957, the Ferus Gallery opened with a group show entitled Objects on the New Landscape Demanding of the Eye. It featured works by many of the pair's friends as well as a rich sampling of important contemporary work from San Francisco, including canvases by Richard Diebenkorn, Frank Lobdell, and Clyfford Still.", page: 1025 },
      { text: "Rather than supporting each other in any particular aesthetic positions, the Ferus artists supported each other in their living; their own sense of community sheltered them from the relative indifference with which the community at large greeted their efforts.", page: 1107 },
      { text: "\"The Italian painter Giorgio Morandi captivated a lot of us,\" Irwin recalls,", page: 1269 },
      { text: "A good painting has a gathering, interactive build-up in it. It's a psychic build-up, but it's also a pure energy build-up. And the good artists all knew it, too. That's what a good Vermeer has, or a raku cup, or a Stonehenge. And when they've got it, they just jump off the goddamn wall at you. They just, bam!\"", page: 1363 },
